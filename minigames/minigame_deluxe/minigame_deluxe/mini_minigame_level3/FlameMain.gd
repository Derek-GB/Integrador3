...
const FLAME_SCENE_PATH := "res://minigames/minigame_deluxe/minigame_deluxe/mini_minigame_level3/Flame.tscn"
...
func _ready():
	...
	if extinguish_flame_sound:
		AudioManager.register_sfx_player(extinguish_flame_sound)
