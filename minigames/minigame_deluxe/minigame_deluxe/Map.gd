...
const RESULT_FINAL_PANEL_SIZE := Vector2(520, 380)
...
var escenas_minijuego := {
	1: "res://minigames/minigame_deluxe/minigame_deluxe/mini_minigame_level1/FloodGame.tscn",
	2: "res://minigames/minigame_deluxe/minigame_deluxe/mini_minigame_level2/FaucetGame.tscn",
	3: "res://minigames/minigame_deluxe/minigame_deluxe/mini_minigame_level3/FlameMain.tscn",
	4: "res://minigames/minigame_deluxe/minigame_deluxe/mini_minigame_level4/WindowsMain.tscn",
	5: "res://minigames/minigame_deluxe/minigame_deluxe/mini_minigame_level5/FarmMain.tscn",
	6: "res://minigames/minigame_deluxe/minigame_deluxe/mini_minigame_level6/RocksMain.tscn",
	7: "res://minigames/minigame_deluxe/minigame_deluxe/mini_minigame_level7/WindMain.tscn",
	8: "res://minigames/minigame_deluxe/minigame_deluxe/mini_minigame_level8/EruptionMain.tscn",
	9: "res://minigames/minigame_deluxe/minigame_deluxe/mini_minigame_level9/ColdMain.tscn",
	10: "res://minigames/minigame_deluxe/minigame_deluxe/mini_minigame_level10/AskMain.tscn"
}
...
func _ready():
	...
	if background_sound:
		AudioManager.register_music_player(background_sound)
...
func _setup_resultado_sound():
	...
	AudioManager.register_music_player(resultado_sound_player)
...
func _setup_resultado_final_ui():
	...
	resultado_final_menu_boton.custom_minimum_size = RESULT_FINAL_BUTTON_SIZE
	resultado_final_menu_boton.size_flags_horizontal = Control.SIZE_SHRINK_CENTER
	resultado_final_menu_boton.add_theme_font_size_override("font_size", 20)

	var estilo_boton_menu := estilo_boton.duplicate()
	var estilo_boton_menu_hover := estilo_boton_hover.duplicate()
	var estilo_boton_menu_press := estilo_boton_press.duplicate()

	resultado_final_menu_boton.add_theme_stylebox_override("normal", estilo_boton_menu)
	resultado_final_menu_boton.add_theme_stylebox_override("hover", estilo_boton_menu_hover)
	resultado_final_menu_boton.add_theme_stylebox_override("pressed", estilo_boton_menu_press)
	resultado_final_menu_boton.add_theme_color_override("font_color", COLOR_BOTON_TEXTO)
	resultado_final_menu_boton.add_theme_color_override("font_hover_color", COLOR_BOTON_TEXTO)
	resultado_final_menu_boton.add_theme_color_override("font_pressed_color", COLOR_BOTON_TEXTO)
