...
const FLOATING_OBJECT_SCENE_PATH := "res://minigames/minigame_deluxe/minigame_deluxe/mini_minigame_level1/FloatingObject.tscn"
const OBJECTS_FOLDER := "res://minigames/minigame_deluxe/minigame_deluxe/mini_minigame_level1/assets/"
...
func _ready():
	...
	if pick_object_sound:
		AudioManager.register_sfx_player(pick_object_sound)
