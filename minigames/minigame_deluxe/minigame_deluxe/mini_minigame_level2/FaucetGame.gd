...
const FAUCET_SCENE_PATH := "res://minigames/minigame_deluxe/minigame_deluxe/mini_minigame_level2/Faucet.tscn"

# Ajusta estas rutas a tus 3 pngs de color (los que ya tienes en tu carpeta assets).
const FAUCET_TEXTURE_PATHS := [
	"res://minigames/minigame_deluxe/minigame_deluxe/mini_minigame_level2/assets/key_gray.png",
	"res://minigames/minigame_deluxe/minigame_deluxe/mini_minigame_level2/assets/key_golden.png",
	"res://minigames/minigame_deluxe/minigame_deluxe/mini_minigame_level2/assets/key_blue.png",
]
...
func _ready():
	...
	if close_faucet_sound:
		AudioManager.register_sfx_player(close_faucet_sound)
