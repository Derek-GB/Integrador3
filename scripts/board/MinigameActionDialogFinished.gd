...
@onready var name_player: Label = $DialogPanel/NamePlayer
...
func setup_action(did_win: bool, reward_data: Dictionary, num_player: int) -> void:
	...
	name_player.text = "Jugador " + str(num_player+1)
